...
export const metadata: Metadata = {
  title: 'Our Story | Photoframes by VF',
  description:
    'Discover the story behind Photoframes by VF — a Nigerian brand crafting premium custom acrylic frames and gold-layered jewellery for life\'s most cherished milestones.',
  openGraph: {
    title: 'Our Story | Photoframes by VF',
    description:
      'Discover the craftsmanship and heart behind Photoframes by VF.',
    type: 'website',
    locale: 'en_NG',
  },
};
